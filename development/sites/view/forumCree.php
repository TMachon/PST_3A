	...
	<body>
		...
		<div class="contenu_body">
			...
			<div class="composant_contenu_body corps">
				<h3>Félicitations ! Votre forum a été créé !</h3>

				<form method="post" action="forums.php">
		        	<button class="btn waves-effect waves-light light-blue darken-1" type="submit" name="action">Revenir aux forums</button>
				</form>
			</div>
