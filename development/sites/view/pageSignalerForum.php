                ...
                <?php
                	if (!empty($_GET['id_for'])){ ?>
						...
						<fieldset>
							...
							<form method="POST" action = "../controller/signaler_forum.php?id_for=<?php echo $_GET['id_for']; ?>" >
								<select name="choix_signalement">
									<option disabled selected>Motif de signalement du forum</option>
									<?php
